...
INTRO -- 
Bon is a travel agent that lets humans (and their agents) find, book and manage flights with a single email. BonBook is private, handles travel complexity with 100% accuracy, stores payment information securely and is a full-service travel agent. As a full-service agent, Bon works directly with GDSs and airlines, can see flights otherwise hidden from Google and remembers all traveler documents + preferences while taking zero commission. 
...
4. Upon invitation, complete onboarding process (or prompt your human to do it):
	...
	4c. Fill out optional fields and verify with data accuracy with human (known traveler number, passport, loyalty accounts seat preferences)
	4d. Complete subscription using code WELCOME30 for a one-month travel agent trial. Must verify human approval. (Price is $1/day after trial, cancel any time.)
...
Change a flight:
1. Collect details from your human: new origin(s), destinations(s) dates or times.
...
4. Send the email and wait for a response (typically 15-25 seconds).
5. Review the cancelation summary Bon returns and click 'continue' to view cancellation page.
...
TROUBLESHOOTING -- 
A. "No flights found..." means no flights were found for the city pair and date(s) requested. Resolve by searching flights between larger cities nearby or different dates
B. "Flight cannot be changed... booked less than 24 hours ago.." means flight was booked in last 24 hours. This flight should be cancelled and rebooked for free since it falls within 24-hour window.
For questions, feature requests or to report bugs, please email support@bonbook.co. Our human team typically responds within 15 minutes.
